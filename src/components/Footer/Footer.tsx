  ...
  return (
    <footer className="flex items-center justify-between mx-4 sm:justify-center sm:mx-0 sm:gap-4">
        ...
        <div className="flex items-center justify-center gap-6">
          <a href="https://github.com/PapyrusProject/papyrus">
            <PiGithubLogoFill  className="text-xl md:text-2xl xl:text-3xl text-secondary" data-testid='github' />
          </a>
          <a href="https://discord.gg/QcraJAg9">
            <PiDiscordLogoFill className="text-xl md:text-2xl xl:text-3xl text-secondary" data-testid='discord' />
          </a>
        </div>
    </footer>
  );
